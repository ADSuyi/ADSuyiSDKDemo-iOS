...
# Admobile ADSuyiSDK iOS接入文档 v3.7.0.12221
...
| Name         | 版本号      |  
|--------------|-------------|           
| ADSuyiSDK | 3.7.0.12221 |    
| tianmu | 2.0.0.1.11211 | 
| baidu | 5.11.12221 |    
| gdt | 4.14.02.12221 |    
| ksad | 3.3.36.12221 |    
| mintegral | 7.2.8.10261 |    
| toutiao | 5.0.0.4.10261 | 
| gromore | 3.9.0.2.12222 | 
| inmobi | 7.5.0.01071 |  
...
pod 'ADSuyiSDK','~> 3.7.0.12221' # 主SDK 必选
...
[点击进入SDK下载地址](https://doc.admobile.top/iOSSDK/ADSuyi_iOS_37012221_72859d67eea2bb5c9e04335d75e82fc6.zip)下载各SDK拖入到工程中
...
`OC请求开屏代码示例：`[[开屏代码示例]](blob/master/ADSuyiSDKDemo-iOS/AppDelegate.m)
