# ADmobile 苏伊广告聚合SDK iOS接入文档 v3.9.7.11061
...
[SDK下载地址](https://doc.admobile.top/iOSSDK/ADSuyi_iOS_39711061_1aefd15798f2c671af0c57c9b836d13c.zip)
...
尊敬的开发者朋友，欢迎您使用ADmobile 苏伊广告聚合SDK，简称“ADSuyiSDK”。通过本文档，您可以在几分钟之内轻松完成广告的集成过程。
...
| Name         | 版本号      |  
|--------------|-------------|           
| ADSuyiSDK | 3.9.7.11061 |    
| tianmu | 2.2.7.1.11061 | 
| baidu | 5.371.08301 |    
| gdt | 4.15.10.07221 |    
| ksad | 3.3.69.3.07221 |    
| toutiao | 6.4.2.7.07221 | 
| gromore | 6.5.0.5.11061 | 
| jadyun | 2.5.8.07221 | 
