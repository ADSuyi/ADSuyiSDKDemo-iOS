# ADmobile ADSuyiSDK iOS接入文档 v3.6.1.05197
...
| Name         | 版本号      |  
|--------------|-------------|           
| ADSuyiSDK | 3.6.1.05197 |    
| tianmu | 1.3.0.5.05192 |    
| baidu | 4.87.05191 |    
| gdt | 4.13.65.05191 |    
| ksad | 3.3.23.04141 |    
| mintegral | 7.1.4.05191 |    
| toutiao | 4.4.0.7.05195 | 
| admobile | 3.6.1.05191.1 | 
| gromore | 3.3.1.2 | 
| inmobi | 7.5.0.01071 |  
...
pod 'ADSuyiSDK','~> 3.6.1.05197' # 主SDK 必选
...
[点击进入SDK下载地址](https://doc.admobile.top/iOSSDK/ADSuyi_iOS_36105194_7510d529903909b779ff7f37d3ee5960.zip)下载各SDK拖入到工程中
