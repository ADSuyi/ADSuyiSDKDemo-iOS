# Admobile ADSuyiSDK iOS接入文档 v3.6.6.08242



⚠️注：**Xcode 14** 开发环境需要升级**穿山甲**至 **4.7.1.1**，请务必检查SDK输出的版本信息，确保穿山甲版本为 4.7.1.1；

低版本穿山甲在 **Xcode 14** 开发环境，存在奔溃问题；
...
pod 'ADSuyiSDK','~> 3.6.6.08242' # 主SDK 必选
...
[点击进入SDK下载地址](https://doc.admobile.top/iOSSDK/ADSuyi_iOS_36608242_bff134ebf7da36c5adaf42832796ed58.zip)下载各SDK拖入到工程中
