# Admobile ADSuyiSDK iOS接入文档 v3.7.2.02202
...
| Name         | 版本号      |  
|--------------|-------------|           
| ADSuyiSDK | 3.7.2.02202 |    
| tianmu | 2.0.2.1.02201 | 
| baidu | 5.12.02031 |    
| gdt | 4.14.12.12221 |    
| ksad | 3.3.38.1.02031 |    
| mintegral | 7.2.9.02032 |    
| toutiao | 5.1.0.5.02201 | 
| gromore | 4.0.0.1.02031 | 
| inmobi | 7.5.0.01071 |  
...
pod 'ADSuyiSDK','~> 3.7.2.02202' # 主SDK 必选
...
[点击进入SDK下载地址](https://doc.admobile.top/iOSSDK/ADSuyi_iOS_37202202_7f07e73c5b3f8ce4c11ece8cfdc6116e.zip)下载各SDK拖入到工程中
...
| skipView | UIView\<ADSuyiAdapterSplashSkipViewProtocol> | 跳过按钮的类型，可以通过此接口替换开屏广告的跳过按钮样式 |
...
|:-----------|:--------|
| setBottomSplashWithSuyiPosid: platformListId: platform: appId: appKey: platformPosid: renderType: | 设置保底开屏 （可选） |
...
| adsy_splashAdDidRewardEffective: info: | 开屏达到激励条件 （开启服务器验证后请使用服务端验证判断是否达到条件，无需使用本回调做激励达成判断）  |

**ADSuyiSDKSplashAdZoomOutViewDelegate**：开屏代理方法
| <center>回调函数</center> | <center>回调说明</center>|
|:-----------|:--------|
...
| tolerateTimeout | NSInteger | 请求超时时间,默认为4s,需要设置3s及以上  |
| isMuted | BOOL | 是否静音，默认静音（部分平台支持：优量汇，汇量，快手，Appic  |
