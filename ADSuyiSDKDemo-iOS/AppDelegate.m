...
- (void)loadSplashAd{
    ...
    */
     ...
     *支持穿山甲、优量汇、快手、百度
     */
    [self.splashAd setBottomSplashWithSuyiPosid:@"73128265daffdd6a1d" platformListId:@"11554" platform:@"ksad" appId:@"680200071" appKey:nil platformPosid:@"6802000387" renderType:ADSuyiSplashRenderTypeExpressPro];
    // 7、加载开屏广告
